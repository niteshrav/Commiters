...
export const SERVICE_CARD_MEDIA_CLASS = "stitch-service-card-media" as const;
export const SERVICE_CARD_BODY_CLASS = "stitch-service-card-body" as const;
...
export const SERVICES_GRID_COLUMNS = "repeat(4, minmax(0, 1fr))";
