...
export const CASE_STUDIES_PAGE_MAX_WIDTH = "none" as const;
...
export const CASE_STUDY_SHOWCASE_CARD_IDS = ["opsflow"] as const;
...
export const CASE_STUDY_TAG_CYAN_CLASS = "case-study-tag--cyan" as const;
export const CASE_STUDY_CATEGORY_CLASS = "case-study-category-badge" as const;
export const CASE_STUDY_IMPACT_CLASS = "case-study-impact" as const;
export const CASE_STUDY_IMPACT_ITEM_CLASS = "case-study-impact-item" as const;
