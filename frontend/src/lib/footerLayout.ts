...
export const FOOTER_MOCKUP_PADDING_BLOCK = "clamp(36px, 4vw, 48px)";
export const FOOTER_MOCKUP_PADDING_BLOCK_MIN_PX = 36;
export const FOOTER_MOCKUP_PADDING_BLOCK_MAX_PX = 48;
/** Home mockup sits flush under the dark CTA (no default footer top margin). */
export const FOOTER_HOME_MOCKUP_MARGIN_TOP = "0";
export const FOOTER_MOCKUP_ROW_GAP = "8px";
