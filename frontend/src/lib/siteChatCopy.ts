...
export const SITE_CHAT_LAUNCHER_CLASS = "site-chat-launcher" as const;
export const SITE_CHAT_PANEL_CLASS = "site-chat-panel" as const;
export const SITE_CHAT_TEST_ID = "site-chat-widget" as const;
