...
import { SocialBrandIcon } from "./icons";
import {
...
export default function MobileNavDrawer({ ctaLabel, ctaUrl, onNavigate }: Props) {
  ...
  return createPortal(
    <div className={MOBILE_NAV_OVERLAY_CLASS}>
      <div
        className={MOBILE_NAV_DRAWER_CLASS}
