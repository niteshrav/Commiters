...
describe("AboutIntroSection", () => {
  it("renders the Stitch about intro aligned with the header logo inset", () => {
    ...
    expect(screen.getByTestId(BRAND_WATERMARK_TESTID)).toBeInTheDocument();
    ...
    expect(screen.getByText(STITCH_COPY.about.kicker)).toHaveClass(ABOUT_INTRO_KICKER_CLASS);
